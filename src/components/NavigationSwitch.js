...
const rightSelectedDektop = `url('data:image/svg+xml;utf8,<svg width="20" height="20" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="11" cy="11" r="6.85714" stroke="${encodeURIComponent(
  '#fff'
...
const rightSelectedMobile = `url('data:image/svg+xml;utf8,<svg width="10" height="10" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="11" cy="11" r="6.85714" stroke="${encodeURIComponent(
  '#fff'
)}" stroke-width="2"/><circle cx="11" cy="11" r="4.5" stroke="${encodeURIComponent(
  '#fff'
)}"/><path d="M11 1V3.85714" stroke="${encodeURIComponent(
...
const rightUnselectedDesktop = `url('data:image/svg+xml;utf8,<svg width="20" height="20" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="11" cy="11" r="6.85714" stroke="${encodeURIComponent(
  '#000'
)}" stroke-width="2"/><circle cx="11" cy="11" r="4.5" stroke="${encodeURIComponent(
  '#000'
)}"/><path d="M11 1V3.85714" stroke="${encodeURIComponent(
...
const rightUnselectedMobile = `url('data:image/svg+xml;utf8,<svg width="10" height="10" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="11" cy="11" r="6.85714" stroke="${encodeURIComponent(
  '#000'
)}" stroke-width="2"/><circle cx="11" cy="11" r="4.5" stroke="${encodeURIComponent(
  '#000'
)}"/><path d="M11 1V3.85714" stroke="${encodeURIComponent(
...
const NavigationSwitchComponent = styled((props) => <Switch disableRipple {...props} />)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& .MuiSwitch-thumb:before': {
        // Right Selected
        backgroundImage: rightSelectedDektop,
        [theme.breakpoints.down('md')]: {
          backgroundImage: rightSelectedMobile,
        },
      },
      '& + .MuiSwitch-track': {
        opacity: 1,
        ...
        '&:before': {
          ...
          content: "''",
          // Left Unselected
          backgroundImage: leftUnselectedDesktop,
          ...
          top: 15,
          [theme.breakpoints.down('md')]: {
            backgroundImage: leftUnselectedMobile,
            height: 24,
            width: 24,
            left: 10,
            top: 10,
  ...
  '& .MuiSwitch-thumb': {
    ...
    '&:before': {
      ...
      // Left Selected
      backgroundImage: leftSelectedDesktop,
      [theme.breakpoints.down('md')]: {
        backgroundImage: leftSelectedMobile,
      },
    },
  },
  '& .MuiSwitch-track': {
    ...
    '&:before': {
      ...
      // Right Unselected
      backgroundRepeat: 'no-repeat',
      backgroundImage: rightUnselectedDesktop,
      height: 40,
      width: 40,
      right: -5,
      top: 15,
      [theme.breakpoints.down('md')]: {
        backgroundImage: rightUnselectedMobile,
        height: 24,
        width: 24,
        right: -5,
        top: 10,
...
const NavigationSwitch = forwardRef(({ value, onChange = () => {}, ...props }, ref) => (
